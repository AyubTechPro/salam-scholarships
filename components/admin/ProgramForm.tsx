  ...
  return (
    <div className="max-w-4xl animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-bold text-white">{initialData ? t("updateProgram") : t("publishProgram")}</h1>
          <p className="text-gray-400 mt-1">{initialData ? t("updateProgram") : t("publishProgram")}</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-300">{t("programTitle")}</label>
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-300">{t("institution")}</label>
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-300">{t("country")}</label>
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-300">{t("deadline")}</label>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl space-y-6">
          <h2 className="text-xl font-semibold text-white border-b border-white/10 pb-4">{t("categorization")}</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-300">{t("level")}</label>
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-300">{t("fundingType")}</label>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-xl space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-300">{t("coverImage")}</label>
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-gray-300">{t("websiteUrl")}</label>
          ...
          <div className="flex items-center gap-3 pt-4">
            ...
            <label htmlFor="requiresEnglishCert" className="text-gray-300">{t("reqEnglish")}</label>
          </div>
        </div>
        ...
        <div className="flex justify-end pt-4">
          ...
          >
            ...
            {isSubmitting ? tCommon("saving") : (initialData ? t("updateProgram") : t("publishProgram"))}
          </button>
        </div>
      </form>
    </div>
