...
export async function generateMetadata({ params: { locale } }: { params: { locale: string } }): Promise<Metadata> {
  ...
  const title = locale === 'ru' ? page?.titleRu || page?.title || 'Privacy Policy' :
                locale === 'tj' ? page?.titleTj || page?.title || 'Privacy Policy' :
                page?.title || 'Privacy Policy';

  return {
    title,
    description: 'Privacy Policy - Salam Scholarships',
  };
}
